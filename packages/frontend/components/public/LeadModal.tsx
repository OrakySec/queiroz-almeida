        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="relative w-full max-w-lg bg-white rounded-3xl shadow-[0_50px_100px_-20px_rgba(0,0,0,0.4)] overflow-hidden pointer-events-auto"
            >
              {/* Header */}
              <div className="bg-brand-dark px-8 pt-10 pb-10 relative overflow-hidden rounded-t-3xl">
                <div className="absolute inset-0 bg-blueprint opacity-[0.05] pointer-events-none" />

                <div className="relative z-10 flex justify-between items-start mb-8">
                  <div className="max-w-xs">
                    <span className="font-sans text-[10px] font-bold uppercase tracking-[0.3em] text-brand-marinho-glow block mb-4 border-l border-brand-marinho-glow pl-3 leading-none">
              ...
              {/* Form */}
              <div className="px-8 py-8 bg-white rounded-b-3xl">
